# Login Web Services — GA7-220501096-AA5-EV01
...
2. Copiar la carpeta `Camilo_Tibata_AA5_EV01` dentro de `C:\xampp\htdocs\`.
...
6. Abrir `http://localhost/Camilo_Tibata_AA5_EV01/`.
7. Importar en Postman `postman/GA7-220501096-AA5-EV01.postman_collection.json`.
